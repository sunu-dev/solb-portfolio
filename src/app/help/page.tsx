...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      {
        q: '하루 몇 번 받을 수 있어요?',
        a: '무료 회원은 하루 1번, PRO 회원은 하루 30번까지 받을 수 있어요. 페이지를 새로고침해도 한도는 차감되지 않아요. 명시적으로 "새로 촉 받기" 버튼을 눌러야 1번 차감돼요.',
      },
      {
        q: '비로그인으로도 사용 가능한가요?',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'AI 촉은 왜 못 숨겨요?',
        a: 'AI 촉 바로가기는 영구 무료로 계속 열어두는 기능이라 항상 표시돼요(자물쇠 표시). 그 외 보조 위젯은 자유롭게 켜고 끌 수 있어요.',
      },
    ],
  },
  {
