    ...
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '48px 24px', fontFamily: "'Pretendard Variable', sans-serif", background: 'var(--bg, #fff)', minHeight: '100vh' }}>
      ...
      <Section title="제5조 (서비스의 내용)">
        ...
        <p style={{ marginTop: 12, fontSize: 13, color: 'var(--text-tertiary, #8B95A1)' }}>
          <strong>고위험 상품 취급 범위</strong>: 단일종목 레버리지·인버스 ETF·ETN(예: 미래에셋 레버리지 삼성전자 단일종목 ETN, KODEX/TIGER/ACE 단일종목 2X·-2X ETF, 미국 TSLL/NVDU 등)은 일일 N배 추종·음의 복리·발행사 신용 위험이 있는 고위험 단기 트레이딩 도구입니다. 서비스는 해당 상품을 AI 촉(관찰 후보)·universe 편입 등 신규 발굴 및 추천 대상에서 영구 제외합니다. 다만 이용자가 직접 보유 등록한 경우에 한하여, 보유 중인 위험을 함께 살피기 위한 사후적 위험 해설(현황·변동성·구조·음의 복리·발행사 신용 위험)을 제공할 수 있으며, 이때에도 매수·매도 시점이나 신규 매매 판단은 제공하지 않습니다. 본 상품의 보유 등록에는 성인 확인과 위험 고지 동의가 선행됩니다.
        </p>
      </Section>
      ...
      <Section title="제7조 (투자 관련 면책)">
        <ol>
          ...
          <li><strong>단일종목 레버리지·인버스 상품(ETF·ETN) 관련</strong>: 본 상품은 일일 수익률의 N배(예: 2배 또는 -2배)를 추종하는 구조로, 장기 보유 시 음의 복리(volatility decay)로 인해 기초자산이 횡보하거나 변동성이 클 경우 원금이 잠식될 수 있습니다. ETN의 경우 발행사 신용 위험(채무불이행 시 원금 손실)이 추가로 존재합니다. 거래소(KRX) 및 금융감독원은 사전 교육 이수와 기본 예탁금 요건을 두고 있으며, 손실 감내 능력과 위험 이해도가 낮은 투자자에게는 부적합하다고 명시하고 있습니다. 서비스는 해당 상품을 신규로 추천하거나 관찰 후보로 제시하지 않습니다. 이용자가 직접 보유 등록한 경우 제공되는 정보는 보유 중인 위험을 함께 살피기 위한 사후적 위험 해설에 한하며, 매수·매도 권유나 신규 매매 판단이 아닙니다. 본 상품의 보유 등록 및 위험 해설 열람에는 성인 확인과 위험 고지 동의가 선행됩니다.</li>
