...
const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  'near-52w-low': {
    term: '52주 저점 근접',
    oneLine: '1년 중 최저가 근처',
    detail: '52주 최저가에 가까운 상태예요. 가치 매수 관점에서 관심 가질 만하지만, 추세가 더 내려갈 수 있으니 기업 펀더멘털을 꼭 확인해주세요.',
  },
  'stoploss-hit': {
    term: '손절가 도달',
  ...
  'buy-zone': {
    ...
    detail: '관심종목에 설정한 매수가 이하로 내려왔어요. 매수 시나리오를 검토할 타이밍이지만, 해당 가격대가 된 이유(뉴스/실적)를 먼저 확인해주세요.',
  },
  'daily-surge': {
    term: '급등',
    oneLine: '하루 동안 큰 폭으로 상승',
    detail: '일일 등락률이 +5% 이상이에요. 뉴스/실적/단순 반등 등 원인이 다양해요. 추격 매수 전에 원인과 지속 가능성을 확인해주세요.',
  },
  'daily-plunge': {
    term: '급락',
