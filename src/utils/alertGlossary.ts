...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  'death-cross': {
    ...
    detail: '50일선이 200일선을 뚫고 내려간 상태예요. 하락 추세 전환 신호로 보지만, 이미 많이 빠진 뒤 나오는 경우가 많아요. 지연 지표라는 점을 참고하세요.',
  },
  'bb-lower': {
    term: '볼린저밴드 하단',
    oneLine: '통계적 과매도 영역 — 변동성 대비 낮은 극단',
  ...
  'near-52w-low': {
    term: '52주 저점 근접',
    oneLine: '1년 중 최저가 근처',
    detail: '52주 최저가에 가까운 상태예요. 여기서 반등하기도, 더 내려가기도 해요. 기업 펀더멘털을 함께 확인해주세요.',
  },
  'stoploss-hit': {
    term: '손절가 도달',
  ...
  'target-hit': {
    ...
    detail: '처음 정한 목표에 도달했다는 사실 알림이에요. 이후 어떻게 할지는 본인이 세운 계획에 달려 있어요.',
  },
  'target-near': {
    term: '목표 수익 근접',
    oneLine: '목표에 거의 도달',
    detail: '설정한 목표의 90% 이상까지 왔어요. 처음 세운 계획을 미리 확인해두기 좋아요.',
  },
  'below-avgcost': {
    term: '평단 하회',
    oneLine: '현재가가 평균 매수가 아래로 내려감',
    detail: '수익 상태에서 손실 상태로 전환됐어요. 추세 전환인지 단기 조정인지 구분이 중요해요. 손절가를 설정해두면 이런 순간의 판단 기준이 생겨요.',
  },
  'buy-zone': {
    term: '관심 매수가 도달',
    oneLine: '관심종목이 원하던 가격에 진입',
    detail: '관심종목에 본인이 설정한 가격 이하로 내려왔다는 알림이에요. 이 가격대가 된 이유(뉴스/실적)를 먼저 확인해주세요.',
  },
  'daily-surge': {
    term: '급등',
    oneLine: '하루 동안 큰 폭으로 상승',
    detail: '일일 등락률이 +5% 이상이에요. 뉴스/실적/단순 반등 등 원인이 다양해요. 원인을 먼저 확인해보세요. 이어질지는 아무도 몰라요.',
  },
  'daily-plunge': {
    term: '급락',
    oneLine: '하루 동안 큰 폭으로 하락',
    detail: '일일 등락률이 -5% 이상이에요. 뉴스/실적 악재, 시장 전반 하락 등 다양한 원인이 있어요. 감정적으로 대응하기 전에 이유를 확인하는 게 중요해요.',
  },
  'composite-strong-uptrend': {
    term: '강한 상승 추세',
    oneLine: '여러 지표가 동시에 강세 신호',
    detail: 'MACD, RSI, 이동평균 등 여러 기술 지표가 동시에 상승 추세를 가리켜요. 앞으로도 이어질지는 아무도 몰라요.',
  },
  'composite-strong-downtrend': {
    term: '강한 하락 추세',
    oneLine: '여러 지표가 동시에 약세 신호',
    detail: '여러 지표가 동시에 하락을 가리키는 상태예요. 단순 조정일 수도, 더 이어질 수도 있어요. 설정해둔 기준이 있다면 함께 살펴보세요.',
  },
  ...
  'composite-overheated': {
    ...
    detail: 'RSI, BB 상단, 거래량 급증 등이 겹친 상태예요. 단기 조정이 나타나기도 하지만, 강한 상승장에선 과열이 이어지기도 해요.',
  },
  'composite-squeeze': {
    term: '볼린저 스퀴즈',
  ...
  'target-return': {
    term: '목표 수익률 달성',
    oneLine: '설정한 % 목표 달성',
    detail: '수익률 기준 목표에 도달했어요. 어떻게 할지는 본인이 세운 원칙에 달려 있어요.',
  },
  'target-profit-usd': {
    term: '목표 수익금 ($) 달성',
    oneLine: '설정한 달러 금액 목표 달성',
    detail: '미리 정한 달러 기준 이익 목표에 도달했어요. 본인이 세운 기준과 함께 판단해보세요.',
  },
  'target-profit-krw': {
    term: '목표 수익금 (₩) 달성',
  ...
  'portfolio-down': {
    ...
    detail: '개별 종목이 아닌 포트폴리오 전체가 크게 내려간 상태예요. 개별 종목보다 시장 전반이 함께 움직인 경우일 수 있어요. 감정 대응 금지.',
  },
};
