...
const GREETINGS: Greeting[] = [
  ...
  { text: '잠이 안 오시나요? SOLB가 함께할게요', emoji: '🌙', condition: { hours: [0,1,2,3] } },
  ...
  { text: '하루의 시작, SOLB와 함께해요', emoji: '🌤️', condition: { hours: [6,7,8,9,10,11] } },
  ...
  { text: '주말엔 투자 공부 한 스푼? SOLB가 도와줄게요', emoji: '📚', condition: { isWeekend: true } },
  ...
  { text: '스승의 날이에요. SOLB도 좋은 스승이 되고 싶어요', emoji: '🌹', condition: { dates: ['05-15'] } },
