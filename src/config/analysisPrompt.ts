...
3. **저평가 여부** — 역사적 PER 대비 할인되었거나 52주 저점 근처 종목
  ...
  "picks": [
    {
      ...
      "krName": "한국어 이름",
      "sector": "섹터",
      "reason": "촉이 온 이유 15자 이내 (유형 + 선택 기준 기반)",
      "keyMetric": "핵심 특징 한 줄 (유형 관점, 예: 가치형 저PER 우량주)"
    }
  ],
  "context": "유저 투자 유형 관점에서 이 3종목에 촉이 온 이유 1~2문장 (~에요 체)"
}`;
