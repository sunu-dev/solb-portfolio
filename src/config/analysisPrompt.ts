...
### 단일종목 레버리지·인버스 ETF/ETN (분석 거부 대상)
...
→ **분석 거부 응답 강제**: "이 상품은 주비 분석 대상이 아니에요. 일일 N배 추종, 음의 복리, 발행사 신용 위험이 있어 학습용 앱 범위 밖이에요. 자세한 정보는 발행사 공시·금융감독원 안내를 확인해주세요."
→ 종목명에 '레버리지'·'인버스'·'곱버스'·'단일종목'·'2X' 키워드 또는 한국 ETN 종목코드(520xxx) 포함 시 자동 적용
→ 기술적 지표·재무 분석·52주 맥락·매수/매도 시사 일절 금지
→ 사용자가 보유 중이어도 가격만 표시, 분석 결과는 거부 메시지로 대체
→ 금감원 가이드: 사전교육 2시간·예탁금 1000만원·적합성 의무 — 주비 페르소나(초보 학습자) 부적합
