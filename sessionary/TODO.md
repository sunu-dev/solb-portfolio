...
>
> **🔴 파운더 1순위**: **Finnhub API 키 회전** — 여전히 유출 간주.
> **🔴 파운더 2순위**: **BOJ 조사통계국 통보** — api_notice §1 의무, API 쓰는 서비스가 이미 배포됨.
> ---
...
- [ ] **5지표 카드 육안 검증** — 펼침 6구조가 모바일 320~375px에서 넘치지 않는지, 다크모드,
  '다음 발표' 배지(FOMC 최장 라벨). 기준값: 10년물 4.71 · Fed 3.50~3.75 · CPI +3.4 · 실업률 4.1 · 일본 0.977
- [ ] **일본 CPI** — FRED 계열 2021년 중단·OECD에 일본 부재. e-Stat(총무성) **무료 키 발급 필요**(파운더)
- [ ] **3단계 한국** — 한국은행 ECOS **무료 인증키 필요**(파운더). OECD 물가에는 한국이 있어 대안 가능
